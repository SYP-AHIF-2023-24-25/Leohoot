...
export class TeacherDemoModeQuizComponent {
  @ViewChild('autoplay') audio!: ElementRef<HTMLAudioElement>;
  ...
  constructor() {
    this.demoQuiz = new DemoQuiz(
      ...
      [
        ...
        new Question(
          'Which animals are in our mascot?',
          20,
          [
        ...
        new Question(
          ...
          [
            ...
            new Answer(
              'über 90, er hat den Führerschein in seinen jungen Jahren gemacht',
              false,
            ),
          ],
        ),
        new Question(
          'Wie heißt Pippi Langstrumpfs Affe?',
          15,
          [
            new Answer('Herr Peterson', false),
            new Answer('Nils Holgerson', false),
            new Answer('Herr Nilsson', true),
          ],
          'assets/images/herr-nilsson.jpg',
        ),
      ],
      'Hooti',
    );
